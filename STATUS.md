...
| 8 | **Data half DONE 2026-08-27** — Oskaras ran the pipeline locally: **`DATASET-998919e0db23`** = 90 files (30 pairs × 1d/4h/1h since 2021), **1,792,725 bars, zero gaps, zero duplicates**; post-2021 listings correctly start at their listing dates. Committed to `verslas-signals/data/`. **Remaining:** verify costs.yaml VERIFY values (Nojus reviews); lock holdout dates at the build session with the hypotheses | Oskaras | 9 Sep |
